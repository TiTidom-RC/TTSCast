...
class Config:
    ...
    def aiSysPrompt(self, aiCustomTone=None):
        ...
        return 'Répond à la question posée seulement s\'il y en a une, sinon reformule simplement la phrase, sur un ton ' + _aiTone + '. Utilise la recherche en ligne pour déterminer la date et le jour de la semaine précis. Sois clair, bref et concis et conserve les valeurs chiffrées s\'il y en a. Ne pas utiliser d\'emojis. Ne commente pas tes propres actions ou le processus de génération.'
