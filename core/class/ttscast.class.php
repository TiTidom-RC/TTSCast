...
class ttscastCmd extends cmd
{
    ...
    public function dontRemoveCmd() {
        ...
        if (is_object($eqLogic) && $eqLogic->getLogicalId() == 'TTSCast_AI_Stats') {
            message::add('ttscast', __('Les commandes de l\'équipement TTSCast AI Stats ne peuvent pas être supprimées. Désactivez la fonction IA dans la configuration du plugin pour supprimer l\'équipement complet.', __FILE__), null, null);
            return true;
        }
        return false;
    }
