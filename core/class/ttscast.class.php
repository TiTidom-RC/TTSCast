    ...
    public static function dependancy_info() {
        ...
        if (file_exists(jeedom::getTmpFolder(__CLASS__) . '/dependency')) {
            ...
            if (exec(system::getCmdSudo() . system::get('cmd_check') . '-Ec "python3\-requests|python3\-setuptools|python3\-dev|python3\-venv"') < 4) {
                ...
                $return['state'] = 'nok';
            } elseif (exec(system::getCmdSudo() . self::PYTHON3_PATH . ' -m pip freeze | grep -Ewc "PyChromecast==14.0.0|google-cloud-texttospeech==2.16.2|gTTS==2.5.1|androidtvremote2==0.0.14"') < 4) {
                $return['state'] = 'nok';
            } else {
                $return['state'] = 'ok';
            }
